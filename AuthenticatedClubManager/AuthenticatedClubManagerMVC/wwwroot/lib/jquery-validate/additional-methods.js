 ...
 *
 *	<input class="Clubinfo" name="partnumber">
 *	<input class="Clubinfo" name="description">
 *
 *	...will validate unless at least one of them is filled.
 *
 * partnumber:	{require_from_group: [1,".Clubinfo"]},
 * description: {require_from_group: [1,".Clubinfo"]}
 *
 ...
 *	<input class="Clubinfo" name="partnumber">
 *	<input class="Clubinfo" name="description">
 *	<input class="Clubinfo" name="color">
 *
 *	...will validate unless either at least two of them are filled,
 *	OR none of them are.
 *
 * partnumber:	{skip_or_fill_minimum: [2,".Clubinfo"]},
 * description: {skip_or_fill_minimum: [2,".Clubinfo"]},
 * color:		{skip_or_fill_minimum: [2,".Clubinfo"]}
 *
 * options[0]: number of fields that must be filled in the group
 * options[1]: CSS selector that defines the group of conditionally required fields
 *
